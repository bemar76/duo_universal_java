...
class Validator {
	...
	static void validateClientParams(String clientId, String clientSecret, String apiHost) throws DuoException {
	...
	static void validateRedirectUri(String redirectUri) throws DuoException {
		try {
			new URL(redirectUri);
